...
\todo[inline]{Describe PathTree tree structure in detail}

\newpar If-statements in the source input result in an If-node in the tree. If such a node is discovered the two branches from that node are explored and the union of the resulting states is found. \todo{Describe Assume nodes}
