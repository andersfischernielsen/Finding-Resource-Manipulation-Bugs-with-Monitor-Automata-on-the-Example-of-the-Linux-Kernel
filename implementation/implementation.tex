...
\begin{algorithmic}
    \Function{apply\_transition} {effect, map}
        ...
        \State{\Return {\Call{add}{map, r, states}}}
    \EndFunction
    \\
    \Function{explore\_paths} {$tree\_node$} {$map$} 
        ...
        \ElsIf {$tree\_node$ is $\mathit{Seq}(step, next)$}
            \State{effects $\gets$ \Call{filter}{is\_in\_transition\_labels, step.effects}}
