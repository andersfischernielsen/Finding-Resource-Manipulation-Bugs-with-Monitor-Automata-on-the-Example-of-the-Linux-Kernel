...
\todo[inline]{Note: I honestly find the OCaml easier to read than the pseudocode. Do you agree? }
...
\todo[inline]{Note: Here's the pseudocode for comparison.}
...
\todo[inline]{Are these illustrations of data types needed? I think text might be enough, no? }
