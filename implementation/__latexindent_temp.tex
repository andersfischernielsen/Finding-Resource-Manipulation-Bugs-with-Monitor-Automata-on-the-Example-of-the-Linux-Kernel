...
\noindent This section will detail how I have integrated the abstractions defined previously into the EBA framework in order to explore the product of the control flow graph of input programs and monitor automata in order to detect possible bugs. 
...
\begin{itemize}
    ...
    \item Pretty-prints the results and returns these to EBA which in turn shows the results 
\end{itemize}

\noindent The implementation of \texttt{check} initiating the generation of the control flow abstraction using EBA can be seen in Figure \ref{check-implementation}. 
